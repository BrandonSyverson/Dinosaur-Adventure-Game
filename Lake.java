public class Lake {
    ...
    private static int lakeWaterSpawnRate = 100;
    private static int boarSpawnRate = 20;
    private static int tenontosaurusSpawnRate = 7;
    
    public Lake(String name, int chickenSpawnRate){
        this.name = name;
    ...
    public static int getLakeWaterSpawnRate() {
        return lakeWaterSpawnRate;
    }
    public void setLakeWaterSpawnRate(int lakeWaterSpawnRate) {
        this.lakeWaterSpawnRate = lakeWaterSpawnRate;
    }
